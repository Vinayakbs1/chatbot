...
def create_deployment_package():
    ...
    with zipfile.ZipFile("azure_functions_package.zip", "w") as zipf:
    ...
    print("Deployment package created: azure_functions_package.zip")
    ...
    print("8. Upload the 'azure_functions_package.zip' file")
    print("9. Extract the zip file using the command: 'unzip azure_functions_package.zip'")
